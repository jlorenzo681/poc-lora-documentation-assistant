...
def train_lora(model_path, data_dir, adapter_path, batch_size=4, lorap_layers=16, iters=1000):
    """
...
if __name__ == "__main__":
    ...
    parser.add_argument("--batch-size", type=int, default=1, help="Batch size (lower for less memory)")
    ...
    train_lora(args.model, data_dir, adapter_path, args.batch_size, 16, args.iters)
